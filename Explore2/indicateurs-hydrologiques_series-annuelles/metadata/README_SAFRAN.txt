...
Indicateurs des séries annuelles des débits journaliers issus des 9
modèles hydrologiques Explore2 pour la réanalyse SAFRAN. Ces fichiers
NetCDF sont disponibles au téléchargement dans la collection
Explore2 - Projections hydrologiques :
https://entrepot.recherche.data.gouv.fr/dataverse/explore2-projections_hydrologiques

Ce dépôt regroupe un tableau par indicateur et chaîne de simulation,
c'est-à-dire, par modèle hydrologique HM. Ces données sont brutes et
