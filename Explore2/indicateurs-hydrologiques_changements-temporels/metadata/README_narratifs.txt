...
Ensemble des indicateurs des changements par horizons temporels
associés aux 36 chaînes de modélisations de débits journaliers issus
des 9 modèles hydrologiques pour la sélection des 4 narratifs
climatiques Explore2 sous RCP 8.5. Ces fichiers résultent de
l'agrégation temporelle des simulations hydrologiques sous runs
historiques (avant 2005) et des projections hydrologiques (post 2005),
fichiers NetCDF disponibles au téléchargement dans la collection
Explore2 - Projections hydrologiques :
https://entrepot.recherche.data.gouv.fr/dataverse/explore2-projections_hydrologiques

Ce dépôt regroupe un tableau par indicateur, horizon temporel et
chaîne de simulation, c'est-à-dire, scénario d'émission RCP, couple
GCM/RCM, correction de biais BC et modèle hydrologique HM. Ces données
sont brutes et contiennent donc des chaînes de projections jugées
aberrantes / horsains qu'il est possible de filtrer grâce à des
...
compressés selon les différentes phases du régime hydrologique.
