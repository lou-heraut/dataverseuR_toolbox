...
Ensemble des indicateurs des séries par horizons temporels associées
aux 36 chaînes de modélisations de débits journaliers issus de 9
modèles hydrologiques pour la sélection des 4 narratifs climatiques
...
disponibles au téléchargement dans la collection
...
{4} EXP : Identifiant de l’expérience historique (post 2005) ou future
    (post 2005)
